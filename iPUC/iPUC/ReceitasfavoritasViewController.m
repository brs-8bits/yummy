//
//  ReceitasfavoritasViewController.m
//  iPUC
//
//  Created by Ozeias Furtozo on 04/05/17.
//  Copyright © 2017 Barbara Santos. All rights reserved.
//

#import "ReceitasfavoritasViewController.h"
#import "User.h"
...
@interface ReceitasfavoritasViewController ()<UITableViewDelegate, UITableViewDataSource>
...
@implementation ReceitasfavoritasViewController{
...
-(void)getData{
    [ReceitaBusiness getFavoritesReceitas:^(id responseObject) {
        _data = [[NSMutableArray alloc] init];
