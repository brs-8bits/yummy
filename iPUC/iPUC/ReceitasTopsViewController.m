//
//  ReceitasTopsViewController.m
//  iPUC
//
//  Created by Ozeias Furtozo on 28/04/17.
...
#import "JTProgressHUD.h"
#import "Receita.h"
#import "ReceitasTopsViewController.h"
#import "ReceitaBusiness.h"
#import <SDWebImage/UIImageView+WebCache.h>

@interface ReceitasTopsViewController () <UITableViewDelegate, UITableViewDataSource>
...
@implementation ReceitasTopsViewController{
...
-(void)getData{
    [ReceitaBusiness getTopReceitas:^(id responseObject) {
        _data = [[NSMutableArray alloc] init];
